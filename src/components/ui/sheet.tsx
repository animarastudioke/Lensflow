    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'top' &&
            'top-0 left-0 right-0 h-auto border-b data-[state=closed]:slide-out-to-top',
          side === 'bottom' &&
            'bottom-0 left-0 right-0 h-auto border-t data-[state=closed]:slide-out-to-bottom',
          side === 'left' &&
            'left-0 top-0 bottom-0 w-3/4 max-w-sm border-r data-[state=closed]:slide-out-to-left sm:max-w-sm',
          side === 'right' &&
            'right-0 top-0 bottom-0 w-3/4 max-w-sm border-l data-[state=closed]:slide-out-to-right sm:max-w-sm',
          className
        )}
        {...props}
      >
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn('text-heading-lg font-semibold', className)}
    {...props}
  />
))
