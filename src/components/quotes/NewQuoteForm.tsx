...
export function NewQuoteForm({ studioSlug, clients }: NewQuoteFormProps) {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <h1 className="text-display-md font-display font-semibold text-foreground">New Quote</h1>
        <p className="text-body text-muted-foreground mt-1">Put together an estimate for a client</p>
      </div>
      ...
      <form onSubmit={onSubmit}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Title, client, and dates</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="title">Title</Label>
              <Input id="title" name="title" placeholder="Wedding Photography Package" required maxLength={150} />
            </div>
        ...
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>What this quote is estimating</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2 pt-2">
              ...
              <Textarea id="notes" name="notes" placeholder="Terms, inclusions, or other details" rows={3} maxLength={2000} />
            </div>
          </CardContent>
        </Card>
        ...
        <div className="flex items-center gap-3 mt-6">
          ...
          <Button type="button" variant="outline" asChild>
            <Link href={`/dashboard/${studioSlug}/quotes`}>Cancel</Link>
          </Button>
        </div>
      </form>
    </div>
